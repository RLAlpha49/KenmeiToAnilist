...
export const RematchOptions: React.FC<RematchOptionsProps> = ({
  ...
  return (
    ...
    >
      <Card className="from-white/92 bg-linear-to-br supports-backdrop-filter:backdrop-blur-md relative mb-6 flex flex-col overflow-hidden border border-blue-200/70 via-white/85 to-blue-50/75 py-0 shadow-xl shadow-blue-500/10 dark:border-blue-900/60 dark:from-slate-950/70 dark:via-slate-950/55 dark:to-blue-950/45">
        <div className="from-blue-200/18 via-indigo-200/12 bg-linear-to-br pointer-events-none absolute inset-0 to-transparent dark:from-blue-900/25 dark:via-indigo-900/15 dark:to-transparent" />
        <CardHeader className="bg-linear-to-r relative border-b border-blue-100/60 from-blue-50/80 via-indigo-50/70 to-purple-50/65 py-3 dark:border-blue-900/50 dark:from-blue-950/40 dark:via-indigo-950/35 dark:to-purple-950/30">
        ...
        <CardContent className="relative space-y-5 p-6 pb-4">
              ...
              {statusOptions.map(
                ({
                  ...
                  return (
                    ...
                    >
                      <div className="bg-linear-to-br pointer-events-none absolute inset-0 from-white/70 via-transparent to-transparent opacity-70 dark:from-slate-900/50" />
          ...
          <div className="dark:from-blue-500/12 dark:via-indigo-500/12 dark:to-cyan-500/12 bg-linear-to-r relative flex flex-col gap-3 rounded-2xl border border-blue-200/60 from-blue-500/10 via-indigo-500/10 to-cyan-500/10 p-5 shadow-inner sm:flex-row sm:items-center sm:justify-between dark:border-blue-500/25">
        ...
        <CardFooter className="bg-linear-to-r relative flex flex-col gap-3 border-t border-blue-100/70 from-blue-50/80 via-indigo-50/70 to-purple-50/70 p-4 sm:flex-row sm:items-center sm:justify-between dark:border-blue-900/50 dark:from-blue-950/45 dark:via-indigo-950/35 dark:to-purple-950/30">
          ...
          <Button
            ...
            className="bg-linear-to-r w-full rounded-2xl from-blue-600 via-indigo-600 to-purple-600 text-base font-semibold shadow-lg shadow-blue-500/25 transition hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 focus-visible:ring-blue-400 sm:w-auto"
