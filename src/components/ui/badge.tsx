 ...
 * @description Badge component for displaying status labels with variant support.
 * @source
 */
...
/**
 * Badge component for status labels with polymorphic rendering.
 * @param props - Badge props including variant and asChild for polymorphic rendering.
