 ...
 * @description Navigation menu component with Radix UI for structured navigation links.
 * @source
 */
...
const navigationMenuTriggerStyle = cva(
  "bg-background hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground data-active:bg-accent/50 data-[state=open]:bg-accent/50 focus:outline-hidden group inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50",
);
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}{" "}
    <ChevronDown
      className="relative top-px ml-1 h-3 w-3 transition duration-200 group-data-[state=open]:-rotate-90"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
));
