...
/**
 * AniList API rate limit (requests per minute). Using 28 instead of 30 to provide safety margin.
 * @source
 */
export const API_RATE_LIMIT = 28;

/**
 * Minimum interval between requests (milliseconds). Calculated from API_RATE_LIMIT to stay within rate limit.
 * @source
 */
